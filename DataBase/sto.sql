...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2023 a las 19:54:40
...
(1, 'Deportiva', 'Ropa específicamente creada para la práctica de deporte, tanto por los materiales y tecnologías empleadas como por el diseño, proporcionando al deportista comodidad, seguridad y un mayor rendimiento.', 'Habilitada');
...
(1, '201314255000', '4225-776-3234', 'Jersey Adidas Selección Mexicana Local 2022', 'Adidas tiene para ti este genial jersey de local.', 10, 0, '799.00', '900.00', 14, 'Fisico', 'Unidad', 'ADIDAS', 'HD6899', 'Habilitado', 'L2P8E3H3L6-1.jpg', 1);
